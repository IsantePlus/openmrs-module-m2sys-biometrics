...
public class NationalBioServerClient extends AbstractBioServerClient {
    ...
    public Token getToken(M2SysClient client) {
        String username = client.getProperty(M2SysBiometricsConstants.M2SYS_NATIONAL_USERNAME);
        String password = client.getProperty(M2SysBiometricsConstants.M2SYS_NATIONAL_PASSWORD);
